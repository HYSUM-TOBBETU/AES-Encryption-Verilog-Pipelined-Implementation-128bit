...
module aes_wrapper(
  ...
  // testbench dosyasini ayri olarak yazdik, direkt run simulation yapabilirsiniz. Sureyi biraz uzatmak gerekiyor.
  /*
  reg clk = 0, rst;
  ...
  */
    ...
    // hizli olsun diye en ust modulde sbox ve rconu tutuyoruz ve buradan giris olarak veriyoruz. 
    reg [0:2047] sbox;
    reg [0:319] rcon;
  ...
  // yurutme_zamani ve saymaya basla eski fifolu projeye aitti, ise yaramadigi icin yoruma aliyoruz.
  /*
